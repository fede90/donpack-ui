...
function Carousel() {
  ...
  const itemStyle = {
    ...
    height: '50vh',
    // Aquí puedes agregar más estilos si es necesario para cada elemento del carousel
    // Ejemplo:
    // background: 'url(\'https://images.unsplash.com/photo-1422190441165-ec2956dc9ecc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1600&q=80\')',
    // Más estilos...
  };

  return (
    <div className="carousel relative container mx-auto" style={carouselStyle}>
      <div className="carousel-inner relative overflow-hidden w-full">

      

      <input className="carousel-open" type="radio" id="carousel-1" name="carousel" aria-hidden="true" hidden defaultChecked />
            <div className="carousel-item absolute opacity-0" style={itemStyle}>
                <div className="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1422190441165-ec2956dc9ecc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1600&q=80')` }}>
                    ...
                    <div className="container mx-auto">
                        <div className="flex flex-col w-full lg:w-1/2 md:ml-16 items-center md:items-start px-6 tracking-wide">
                            <p className="text-black text-2xl my-4">Línea Navideña!</p>
                            <a className="text-xl inline-block no-underline border-b border-gray-600 leading-relaxed hover:text-black hover:border-black" href="#">Mirá todos los productos!</a>
                        </div>
                    </div>
            ...
            <div className="carousel-item absolute opacity-0 bg-cover bg-right" style={itemStyle}>
